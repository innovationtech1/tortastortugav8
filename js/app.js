...
window._pedirUbicacionClienteWA = function(pedidoId, telefono, nombre, ticket) {
    ...
    var mensaje =
        ...
        '⏱️ Tu orden se entregará lo más pronto posible. La hora de entrega puede variar según la cantidad de productos ordenados, el tráfico y otras órdenes adelante.\n\n' +
